...
SECRET_KEY = 'django-insecure-9gazozx6ww)w7h$=+abl5b4v+a$jph^7y^%ji&3o=bc=1l8#un'
...
CAS_LOGOUT_URL = 'http://{}/logout'.format(cas_server_host)
CAS_APPLY_ATTRIBUTES_TO_USER = True

ACCOUNNT_LOGIN_REDIRECT_URL = '/'
